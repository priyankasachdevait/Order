...
import com.assignment.order.constants.ApiConstants;
...
public class OrderController {
  ...
  public ResponseEntity<OrderDto> findById(@PathVariable Long id){
    return new ResponseEntity<OrderDto>(orderService.findById(id), HttpStatus.CREATED);
  }

  @GetMapping
  public ResponseEntity<List<OrderDto>> findAll(){
    return new ResponseEntity<List<OrderDto>>(orderService.findAll(), HttpStatus.CREATED);
  }
